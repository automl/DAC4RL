...
class CARLEnv(Wrapper):
            ...
            for key, value in context.items():
                if key in self.whitelist_gaussian_noise:
                    ...
                    context_augmented[key] = context[
                        key
                    ]  # TODO(frederik): sample from categorical?
    ...
    def build_observation_space(
        ...
        if len(obs_shape) == 3 and self.hide_context:
            ...
            # Put infitnite bounds if no bounds are provided
            ...
            if self.hide_context or (
                ...
                # Append the context bounds to the observation space bounds
                ...
                # If single contexts to be appended have been provided
