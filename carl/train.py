...
def get_parser() -> configargparse.ArgumentParser:
    ...
    # TODO Needs to be changed for seperate context
    parser.add_argument(
    ...
    parser.add_argument(
        "--encoder_weights", type=str, default=None, help="Path to encoder weights"
    )

    parser.add_argument(
        "--encoder_input_size", type=int, default=5, help="Size of the input to encoder"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Size of the output of encoder",
    )
...
## TODO re-purpose this with DAC policy
...
## TODO refctor this into an environment
## Write a wrapper that only calls the set_hp function around carl env
## essentially we want a warpper that takes recieves an action and returns the next state and reward
...
def main(args, unknown_args, parser):
    ...
    # This is where we apply a hyperparam configuration to the agent -> TODO Step function
    ...
    # eval callback records performance over all instances while progress writes performance of the last episode(s)
